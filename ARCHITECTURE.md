...
- [VAK Architecture Documentation](#vak-architecture-documentation)
  - [Table of Contents](#table-of-contents)
  - [System Overview](#system-overview)
  - [Design Principles](#design-principles)
  - [Layered Architecture](#layered-architecture)
    - [1. Agent Interface Layer](#1-agent-interface-layer)
    - [2. Kernel Services Layer](#2-kernel-services-layer)
  ...
  - [Data Flow](#data-flow)
    - [Tool Request Lifecycle](#tool-request-lifecycle)
    - [Neuro-Symbolic Verification Flow (High-Stakes Actions)](#neuro-symbolic-verification-flow-high-stakes-actions)
